...
public class PolicyHandler{
    ...
    public void wheneverPaymentCanceled_CancelDelivery(@Payload PaymentCanceled paymentCanceled){
        ...
        if(paymentCanceled.isMe()){
            ...
            if("Canceled".equals(paymentCanceled.getPaymentStatus())){
                Delivery delivery = new Delivery();
                delivery.setOrderId(paymentCanceled.getOrderId());
                delivery.setDeliveryStatus(paymentCanceled.getPaymentStatus());

                deliveryRepository.save(delivery);
            }

            System.out.println("##### listener CancelDelivery : " + paymentCanceled.toJson());
        }
    }
